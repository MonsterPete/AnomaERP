...
namespace Definitions
{
    ...
    public class AzureBlobHelper
    {
        ...
        private String getConnectionString(Int32 accesskeys)
        {
            ...
            switch (accesskeys)
            {
                case 0: { value = "DefaultEndpointsProtocol=https;AccountName=anomastorage;AccountKey=GUwWCEfblyw+pC42zQU/Oz+09wkA2PIImRl8HQmSyjoujQlI4aX+uX38TKnCEmhxVfIlhUS4hKVNhShzQ5s3Pw==;EndpointSuffix=core.windows.net"; } break;
            }
            return value;
        }
    }

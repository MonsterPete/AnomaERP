<%@ Page Title="" Language="C#" MasterPageFile="~/Masterpage.Master" AutoEventWireup="true" CodeBehind="bed-add-accessory.aspx.cs" Inherits="AnomaERP.BackOffice.Bed_Management.Bed.bed_add_accessory" %>
        ...
        <div class="container-fluid flex-grow-1 container-p-y">
                    ...
                    <h4 class="font-weight-bold py-3 mb-2">Bed Management
                            <div class="text-muted text-tiny mt-1">
                                <small class="font-weight-normal text-uppercase">
                                    ...
                                    Bed Management List/Add Accessory
                                </small>
                            </div>
                    </h4>
            ...
            <div class="card mb-3">
                ...
                <h4 class="card-header with-elements">
                    <div class="card-header-title"><strong>Add Accessory</strong></div>
                </h4>
                                        ...
                                        <table class="table table-striped table-hover table-bordered">
                                            ...
                                            <tbody>
                                                <tr class="odd gradeX">
                                                    ...
                                                    <td>
                                                        <div class="form-group mb-0">
                                                            <asp:TextBox ID="txtName" placeholder="Name" runat="server" Enabled="false" CssClass="form-control form-control-sm"></asp:TextBox>
                                                        </div>
                                                    </td>
                                                    <td>
                                                        <div class="form-group mb-0">
                                                            <asp:TextBox ID="txtQtyTotal" placeholder="QTY Total" runat="server" Enabled="false" TextMode="Number" CssClass="form-control form-control-sm"></asp:TextBox>
                                                        </div>
                                                    </td>
                                                    <td>
                                                        <div class="form-group mb-0">
                                                            <asp:TextBox ID="txtQtyBed" placeholder="QTY To Bed" runat="server" TextMode="Number"  CssClass="form-control form-control-sm"></asp:TextBox>
                                                        </div>
                                                    </td>
                                                    <td>

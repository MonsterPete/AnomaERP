                                    ...
                                    <div class="col-sm-12">
                                        <table class="table">
                                            ...
                                            <tbody>
                                                ...
                                                <asp:Repeater ID="rptFloor" runat="server" OnItemDataBound="rptFloor_ItemDataBound" OnItemCommand="rptFloor_ItemCommand">
                                                    <ItemTemplate>
                                                        <tr class="odd gradeX">
                                                            <td>
                                                                <asp:Label ID="lblFloorID" runat="server" Text="" Visible="false"></asp:Label>
                                                                <asp:Label ID="lblBranchID" runat="server" Text="" Visible="false"></asp:Label>
                                                                <asp:TextBox ID="txtFloorName" CssClass="form-control form-control-sm" runat="server"></asp:TextBox>
                                                            </td>
                                                            <td>IS USE
                                                            </td>
                                                            <td class="center">
